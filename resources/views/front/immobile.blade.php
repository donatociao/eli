  ...
  <div class="container mb-4">
    ...
    <div class="row mt-3">
      <div class="col-lg-8">
        ...
        <div class="iframerz"><iframe class="responsive-iframe" src="{{ $immobile_show->video_link }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
      </div>
