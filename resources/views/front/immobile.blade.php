  ...
  <div class="container mb-4">
    ...
    <div class="row mt-3">
      <div class="col-lg-8">
        ...
        <div><iframe class="w-100" src="{{ $immobile_show->video_link }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
      </div>
