  ...
  <div class="container mt-5 mb-5">
    <div class="row">
      <div class="col-lg-12">
        ...
        <p>Noi di <strong><span id="sito">www.eliano.it</span></strong> riteniamo che la privacy dei nostri visitatori sia estremamente importante. Questo documento descrive dettagliatamente i tipi di informazioni personali raccolti e registrati dal nostro sito e come essi vengano utilizzati.</p>
        ...
        <div id="cookies" style="display: block;">
          ...
          <ul>
            ...
            <li>
              ...
              <br>Questi cookie permettono di ricordare le preferenze selezionate dall’utente durante la navigazione, ad esempio, consentono di impostare la lingua.
            </li>
            <li>
              <strong>Attività Statistiche e di Misurazione dell’audience (es: Google Analytics)</strong>
              <br>Questi cookie ci aiutano a capire, attraverso dati raccolti in forma anonima e aggregata, come gli utenti interagiscono con i siti internet fornendo informazioni relative alle sezioni visitate, il tempo trascorso sul sito, eventuali malfunzionamenti. Questo aiuta a migliorare la resa dei siti internet.
            </li>
            <li>
        ...
        <div id="partners" style="display: block;">
          ...
          <ul>
            ...
            <li id="altri_partner" style="display: none;"><span id="partner">Facebook</span></li>
          </ul>
        ...
        <ul>
          <li><b><span id="azienda">Eliano Servizi Immobiliari Soc. Coop.</span></b></li>
          <li id="piva" style="display: block;">P. IVA <span id="iva">05597730653</span></li>
