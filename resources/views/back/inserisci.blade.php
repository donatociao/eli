        ...
        <form class="mt-4" method="post" action="{{route('immobili.store')}}" enctype="multipart/form-data">
          ...
          {{-- <div class="form-row">
            ...
            <div class="form-group col-md-1">
              ...
              <input type="text" class="form-control" id="mq" placeholder="Valore" name"value">
            </div>
            <div class="form-group col-md-1">
          ...
          {{-- <div class="form-row">
            <div id="label"class="form-group d-flex flex-row col-lg-12">
              <div class="col-lg-1 d-flex flex-column align-items-center">
                ...
                <input id="ristrutturato" type="checkbox" checked data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" name="ristrut">
              </div>
              <div class="col-lg-1 ml-3">
                <label for="riscaldamento">Riscaldamento</label>
                <input id="riscaldamento" type="checkbox" checked data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" name="riscald">
              </div>
              <div class="col-lg-1 ml-3">
              ...
              <div class="col-lg-1 ml-3">
                ...
                <input id="posto-auto" type="checkbox" checked data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" name="posto">
              </div>
              <div class="col-lg-1 ml-5">
                <label for="posto-auto"><b>Evidenza</b></label>
                <input id="posto-auto" type="checkbox" checked data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" name="evidenza">
              </div>
            </div>
          </div> --}}
          {{-- <button type="submit" class="mt-2 btn btn-primary">Carica immobile</button>
